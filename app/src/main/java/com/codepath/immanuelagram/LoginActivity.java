                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        if (user != null) {
                                            if (user.isEmailVerified()) {
                                                ...
                                                Toast.makeText(LoginActivity.this, "Please Verify your account before sign in attempt", Toast.LENGTH_SHORT).show();
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    if (username.getText().toString().contentEquals("")) {
                        ...
                        username.setText("Email cannot be empty");


                    } else if (password.getText().toString().contentEquals("")) {


                        password.setText("Password cannot be empty");


                    }  else {


                        mAuth.createUserWithEmailAndPassword(username.getText().toString(), password.getText().toString()).addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(LoginActivity.this, "Authentication failed. Make sure your password is atleast 6 characters.",
                                            Toast.LENGTH_SHORT).show();
